...
foreach ($updates as $id) {
	...
	foreach ($term as $termId => $_term) {
		...
		$_year1 = $year1[$termId] ?? null;
		$_year2 = $year2[$termId] ?? null;
		$_year3 = $year3[$termId] ?? null;
		$_year4 = $year4[$termId] ?? null;
		$_year5 = $year5[$termId] ?? null;
		$_trans = $trans[$termId] ?? null;
